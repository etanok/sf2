 ...
 * @ORM\Entity(repositoryClass="Autoformation\BlogBundle\Entity\CommentaireRepository")
 */
class Commentaire
{
    /**
     ...
     * @return Commentaire
     */
    public function setArticle(\Autoformation\BlogBundle\Entity\Article $article = null)
    {
